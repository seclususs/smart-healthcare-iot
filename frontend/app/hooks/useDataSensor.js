      ...
      try {
        ...
        client.on('message', (topic, message) => {
          ...
          if (topic === 'sensor/spo2') {
            ...
            setDataGrafik((prev) => {
              const lastBpm = prev.length > 0 ? prev[prev.length - 1].bpm : 0;
              const safeBpm = bpmBuffer.current !== null ? bpmBuffer.current : lastBpm;
        ...
        console.error('Gagal memuat sistem:', err);
      }
    };
